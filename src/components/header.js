        ...
        <header className="bg-white shadow-lg mb-8">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <Link to="/" className="-m-1.5 p-1.5">
                    <span className="sr-only">Kafee Book</span>
                ...
                <Link to="/admins" className="text-sm font-semibold leading-6 text-gray-900">Admin Panel</Link>
                <a href="/books"  className="text-sm font-semibold leading-6 text-gray-900">Books</a>
